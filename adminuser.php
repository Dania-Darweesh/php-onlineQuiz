...
if (isset($_GET['do'])) {
  ...
  if ($do == "edit") {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $pass = $_POST['password'];
      if ($check == 1) {
        $sql = "INSERT INTO `users` (`username`,`email`,`password`,`mobile`, `type`) VALUES ('$name','$email','$password','$mobile',0)";
            ...
            <div class="table-data__tool">
              ...
              <div class="table-data__tool-right">
                <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                  <a href="adminuser.php?do=add"><i class="zmdi zmdi-plus"></i>add user</button></a>
                      ...
                      <td>
                        <div class="table-data-feature">
                          <button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                            <a href="adminuser.php?do=edit&id=<?php echo $user['id'] ?>"> <i class="zmdi zmdi-edit"></i> </a>
                          </button>
                          <button class="item" data-toggle="tooltip" data-placement="top" title="Delete">
                            <a href="adminuser.php?delete=<?php echo $user['id'] ?>"> <i class="zmdi zmdi-delete"></i> </a>
                          </button>
                        </div>
                      </td>
                    </tr>
